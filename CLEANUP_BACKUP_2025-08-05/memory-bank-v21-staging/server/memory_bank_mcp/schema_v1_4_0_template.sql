-- Memory Bank v1.4.0 Complete Schema DDL Template
-- Generated: 2025-07-30.1337
-- Purpose: Historical schema record and database version detection
--
-- This DDL represents the unified_documents architecture from Memory Bank v1.4.0
-- - Uses unified_documents as the primary content table
-- - original_uuid field naming convention
-- - No project_uuid for cross-project references
-- - Legacy table structure preserved
-- - Schema version 0-3 (pre-v2.0)

-- Set database version for v1.4.0 (schema versions 0-3)
PRAGMA user_version = 3;

-- Main content table (v1.4.0 - unified_documents architecture)
...
-- Full-text search for unified_documents (v1.4.0)
...
-- Supporting tables (v1.4.0 legacy structure)
...
-- FTS5 tables for legacy structure
...
-- Comprehensive search view (v1.4.0)
...
-- v1.4.0 Schema Complete
-- Key characteristics:
-- - unified_documents as primary content table with original_uuid field
-- - Separate legacy tables (discussions, artifacts, plans, code_iterations)
-- - Multiple FTS5 tables for different content types
-- - comprehensive_search view for unified querying
-- - No cross-project support (no project_uuid in unified_documents)
-- - Schema versions 0-3 (PRAGMA user_version = 0-3)
